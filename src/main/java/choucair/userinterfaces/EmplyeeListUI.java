...
public class EmplyeeListUI {
    ...
    public static final Target BUTTON_DELETE_EMPLOYEE = Target.the("Delete employee button").located(By.cssSelector("i[class='oxd-icon bi-trash']"));
    public static final Target BUTTON_CONFIRM_DELETE_EMPLOYEE = Target.the("Confirm delete employee button").located(By.cssSelector("button[class='oxd-button oxd-button--medium oxd-button--label-danger orangehrm-button-margin']"));
