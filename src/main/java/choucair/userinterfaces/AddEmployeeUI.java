...
public class AddEmployeeUI {
    ...
    public static final Target ADVISE_SUCCESS = Target.the("Success advice").located(By.cssSelector("p[class='oxd-text oxd-text--p oxd-text--toast-title oxd-toast-content-text']"));
